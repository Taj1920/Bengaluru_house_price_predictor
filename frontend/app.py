...
#load cleaned data
response = requests.get("https://bengaluru-house-price-predictor-gt52.onrender.com/cleaned_dataframe")
try:
...
def load_house_anime():
    with open("assets/home_anime.json",'rb') as file:
...
if selection=='Home':
    ...
    response = requests.get("https://bengaluru-house-price-predictor-gt52.onrender.com/unique_locations")
    ...
    if c2.button('💰 Predict Price'):
        input_data = {"location":loc,
                      ...
                      "bhk":bhk,
                      "bath":bath}
        response = requests.post("https://bengaluru-house-price-predictor-gt52.onrender.com/predict_price",json=input_data)
        try:
    ...
    response = requests.get("https://bengaluru-house-price-predictor-gt52.onrender.com/sample_dataframe")
    try:
